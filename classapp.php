...
function infoemail($adminsubject,$adminmessage,$useremail,$usersubject,$usermessage,$todeveloper=True){
	...
	if($this->conf['adminemail']<>'info@ehcp.net'
...
function debuginfo(){ # this is debug info for developer, me !
	...
	#if($this->clientip<>'127.0.0.1' and $this->conf['adminemail']<>'info@ehcp.net' and $this->clientip<>'78.187.86.112') return false;
...
function show($templatefile1='') {
	...
	if($ajax) {
		...
		<body>".$this->output."</body></html>";;
			...
			#if(!$this->isDemo and ($this->conf['adminemail']=='info@ehcp.net')) echo "query count: ".count($this->queries)." <br>".$this->debuginfo();
		}
